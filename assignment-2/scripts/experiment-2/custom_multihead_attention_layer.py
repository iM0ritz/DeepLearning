...
class CustomMultiHeadAttention(layers.Layer):
    ...
    def call(self, inputs, mask=None, return_attention_scores=False):
        attention_output, weights = self.compute_attention_scores(inputs, mask)
        
        # Optionally return the weights along with the output
    ...
    def compute_attention_scores(self, inputs, mask):
        ...
        # Return both the final dense projection and the attention weights
        return ops.matmul(joined_output, self.Wo), weights
